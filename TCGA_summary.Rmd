...
\begin{center}
\includegraphics[height=300px]{res.genes.Analysis2/MIA_all_TCGA_cancers.png}
\end{center}
...
\begin{center}
\includegraphics[height=250px]{res.genes.Analysis2/MIA_BRCA.png}
\end{center}
...
\begin{center}
\includegraphics[height=250px]{res.genes.Analysis3/MIA_BRCA-race-white.png}
\end{center}

## "MIA_BRCA-race-black or african american"

\begin{center}
\includegraphics[height=250px]{res.genes.Analysis3/MIA_BRCA-race-black or african american.png}
\end{center}

## "MIA_BRCA-radiation_therapy-NO"

\begin{center}
\includegraphics[height=250px]{res.genes.Analysis3/MIA_BRCA-radiation_therapy-NO.png}
\end{center}

## "MIA_BRCA-radiation_therapy-YES"

\begin{center}
\includegraphics[height=250px]{res.genes.Analysis3/MIA_BRCA-radiation_therapy-YES.png}
\end{center}
...
knitr::include_graphics('res.genes.Analysis5/BRCA_MIA_PAM50Call_RNAseq.png')  # 'PAM50Call_RNAseq' for BRCA, 'subtype' for OV
```

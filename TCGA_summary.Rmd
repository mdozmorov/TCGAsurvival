...
![](res.genes.Analysis2/MIA_all_TCGA_cancers.png)
...
```{r}
cancers <- read.xlsx("TCGA_cancers.xlsx")
...
![](res.genes.Analysis2/MIA_BRCA.png)
...
```{r}
global_stats <- read.table("TCGAsurvival/res.genes.Analysis3/global_stats.txt", sep = "\t", header = TRUE)
DT::datatable(global_stats[order(global_stats$p.value), ])
```

## Survival effect in "BRCA-race-white" subtype

![](TCGAsurvival/res.genes.Analysis3/MIA_BRCA-race-white.png)

# Analysis 4: methylation of `r gene` gene in `r cancer` cancer

![](TCGAsurvival/res.methylation.Analysis1/cg19023552_BRCA.png)

![](TCGAsurvival/res.methylation.Analysis1/cg25152942_BRCA.png)
...
expr <- read.table("/Users/mdozmorov/Documents/Work/VCU_work/Devanand_Sarkar/TCGAsurvival/TAF2/RSEM_expression_TAF2.data.tsv", header = TRUE, stringsAsFactors = FALSE)
...
for (i in 1:length(cancer)) {
    ...
    t.table[i, 6:8] <- c(round(res$statistic, 3), round(res$parameter, 3), round(res$p.value, 6))
    t.table[i, 9:10] <- c(paste0("(", round(res$conf.int[1], 2), ", ", round(res$conf.int[2], 2), ")"), 
        res$method)
}

cancers <- openxlsx::read.xlsx("/Users/mdozmorov/Documents/Work/GenomeRunner/TCGAsurvival/TCGA_cancers.xlsx")

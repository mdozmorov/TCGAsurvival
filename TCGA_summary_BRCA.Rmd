...
gene   <- "AR" # Search and replace the name of the gene
cancer <- "BRCA"
```
...
\begin{center}
\includegraphics[height=300px]{res.genes.Analysis2/AR_all_TCGA_cancers.png}
\end{center}
...
\begin{center}
\includegraphics[height=250px]{res.genes.Analysis2/AR_BRCA.png}
\end{center}
...
## "BRCA-PAM50Call_RNAseq-Basal"

\begin{center}
\includegraphics[height=250px]{res.genes.Analysis3/AR_BRCA-PAM50Call_RNAseq-Basal.png}
\end{center}

## "BRCA-PAM50Call_RNAseq-LumA"

\begin{center}
\includegraphics[height=250px]{res.genes.Analysis3/AR_BRCA-PAM50Call_RNAseq-LumA.png}
\end{center}
...
knitr::include_graphics('res.genes.Analysis5/BRCA_AR_PAM50Call_RNAseq.png')  # 'PAM50Call_RNAseq' for BRCA, 'subtype' for OV
```

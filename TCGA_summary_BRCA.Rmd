...
## "BRCA-breast_carcinoma_surgical_procedure_name-Modified Radical Mastectomy"

\begin{center}
\includegraphics[height=250px]{res.genes.Analysis3/IGFBP3_BRCA-breast_carcinoma_surgical_procedure_name-Modified Radical Mastectomy.png}
\end{center}

## "BRCA-histological_type-Infiltrating Lobular Carcinoma"

\begin{center}
\includegraphics[height=250px]{res.genes.Analysis3/IGFBP3_BRCA-histological_type-Infiltrating Lobular Carcinoma.png}
\end{center}

## "BRCA-race-black or african american"

\begin{center}
\includegraphics[height=250px]{res.genes.Analysis3/IGFBP3_BRCA-race-black or african american.png}
\end{center}

## "BRCA-breast_carcinoma_progesterone_receptor_status-Positive"

\begin{center}
\includegraphics[height=250px]{res.genes.Analysis3/IGFBP3_BRCA-breast_carcinoma_progesterone_receptor_status-Positive.png}
\end{center}
...
knitr::include_graphics('res.genes.Analysis5/BRCA_IGFBP3_PAM50Call_RNAseq.png')  # 'PAM50Call_RNAseq' for BRCA, 'subtype' for OV
```

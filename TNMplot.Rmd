...
grob <- grobTree(textGrob(paste0("p-value: ", formatC(res, format = "e")), x=0.1,  y=0.90, hjust=0, gp=gpar(col="black", fontsize=8, fontface="italic")))
...
ggsave("results/Figure_TN_paired.png", width = 4, height = 4, dpi = 300)
```
...
ggsave("results/Figure_TNM.png", width = 5, height = 4, dpi = 300)

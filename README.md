...
Scripts are being transitioned to use the [curatedTCGAData](https://bioconductor.org/packages/curatedTCGAData/) and [TCGAutils](https://bioconductor.org/packages/TCGAutils/) packages. See also [cBioPortalData](https://bioconductor.org/packages/cBioPortalData/) R interface to TCGA and the cBioPortal API. <details>
...
- [TNMplot_miRNA.Rmd](examples/TNMplot_miRNA.pdf) - same as `TNMplot.Rmd`, but for miRNA. Additionally, the PAM50-specific expression is plotted. The data is saved into an Excel file (`TCGA_BRCA_miRNA.xlsx`), with PAM50 annotations.
...
- `TCGA_immune.xlsx` - [Table S1 download](https://www.cell.com/cms/10.1016/j.immuni.2018.03.023/attachment/1b63d4bc-af31-4a23-99bb-7ca23c7b4e0a/mmc2.xlsx). PanImmune Feature Matrix of Immune Characteristics. From [Supplementary Material](https://www.cell.com/immunity/fulltext/S1074-7613(18)30121-3#supplementaryMaterial), Thorsson, Vésteinn, David L. Gibbs, Scott D. Brown, Denise Wolf, Dante S. Bortone, Tai-Hsien Ou Yang, Eduard Porta-Pardo, et al. “[The Immune Landscape of Cancer](https://doi.org/10.1016/j.immuni.2018.03.023).” Immunity, April 2018 - TCGA Immune signatures, six immune subtypes. Manually compiled immune gene lists, references in the text. Classification of each TCGA sample in Table S1. M1 macrophages and lymphocyte expression signature in general associated with improved OS.

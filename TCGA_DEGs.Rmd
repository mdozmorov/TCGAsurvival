...
# Adjust as needed
pv.out <- pathview(gene.data = degs.genes, pathway.id = "04070", species = "hsa", gene.idtype = "SYMBOL", gene.annotpkg = "org.Hs.eg.db", out.suffix = paste(selected_genes, collapse = "-"))
```

```{r echo=FALSE, out.height='300px', eval=TRUE}
knitr::include_graphics('hsa04070.LONRF2.png')
```

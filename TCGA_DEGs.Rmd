...
cancer = "BRCA" 
# Gene(s) of interest
selected_genes = c("FOXP3") # Can be multiple
```
...
# Adjust as needed
pv.out <- pathview(gene.data = degs.genes, pathway.id = "04640", species = "hsa", gene.idtype = "SYMBOL", gene.annotpkg = "org.Hs.eg.db", out.suffix = paste(selected_genes, collapse = "-"))
```

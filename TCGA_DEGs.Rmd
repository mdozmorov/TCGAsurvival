...
selected_genes = c("PECAM1"); cancer_RNASeq2 = cancer
...
List of differentially expressed genes are stored in Excel file  *PAAD_CD31_hi51_lo49_DEGs.xlsx*
...
fileName <- paste(cancer, paste(selected_genes, collapse = "-"), paste0("UP", quantile_up * 100), paste0("LO", quantile_lo * 100), "DEGs.xlsx", sep = "_")
...
The most significant pathway with genes overlayes

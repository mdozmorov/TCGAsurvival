...
cancer = "BRCA" 
# Gene(s) of interest
selected_genes = c("DYRK1A") # Can be multiple
```
...
# Adjust as needed
pv.out <- pathview(gene.data = degs.genes, pathway.id = "04110", species = "hsa", gene.idtype = "SYMBOL", gene.annotpkg = "org.Hs.eg.db", out.suffix = paste(selected_genes, collapse = "-"))
```

...
**Results are stored in the Excel file** `r fileName`
...
# Adjust as needed
pv.out <- pathview(gene.data = degs.genes, pathway.id = "04514", species = "hsa", gene.idtype = "SYMBOL", gene.annotpkg = "org.Hs.eg.db", out.suffix = paste(selected_genes, collapse = "-"))
```

![](/Users/mdozmorov/Documents/Work/VCU_work/Theresa/hsa04514.MIA.png)

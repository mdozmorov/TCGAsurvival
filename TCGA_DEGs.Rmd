...
fileNameRes <- paste(cancer, paste(selected_genes, collapse = "-"), paste0("UP", quantile_up * 100), paste0("LO", quantile_lo * 100), "DEGs", pval_cutoff, ".xlsx", sep = "_")
```
...
# Adjust as needed
pv.out <- pathview(gene.data = degs.genes, pathway.id = "04510", species = "hsa", gene.idtype = "SYMBOL", gene.annotpkg = "org.Hs.eg.db", out.suffix = paste(selected_genes, collapse = "-"))
```

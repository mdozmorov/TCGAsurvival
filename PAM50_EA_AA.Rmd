...
# ydata <- colData(matchmae) %>% as.data.frame() %>% select(patientID, race, ethnicity, Integrated.Clusters..with.PAM50.)
# table(ydata$Integrated.Clusters..with.PAM50.)
...
# Number of samples per Race and PAM50 subtypes
...
# Expression analysis in 'black or african-american' and 'white' cohorts, in PAM50 subtypes

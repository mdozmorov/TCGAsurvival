...
# Selected genes
precalculated  <- FALSE
selected_genes <- c("OLIG2") # If nothing precalculated - use one of the genes
...
expression_cutoff <- 0.2   # From 0 to 1, percent cutoff of expression of the selected gene
top_expression    <- FALSE # Whether to take top (TRUE) of bottom (FALSE) expression 
...
fileNameRes <- paste0("results/", cancer_RNASeq2, "_results_", selected_genes, "_", data.type, "_", type,  "_", ifelse(top_expression, "UP", "LO"), expression_cutoff, ".xlsx") # Save results

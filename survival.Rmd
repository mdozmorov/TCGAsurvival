...
system(paste0("rm -r ", selected_genes,".Analysis*"))

# Censor KM plots at certain duration
max_days <- 3650 # 3650 days = 10 years
...
system(paste0("mv res ", selected_genes, ".Analysis1"))
```
...
all_cancers = c("ACC", "BLCA", "BRCA", "CESC", "CHOL", "COAD", "COADREAD", "DLBC", "ESCA", "FPPP", "GBM", "GBMLGG", "HNSC", "KICH", "KIPAN", "KIRC", "KIRP", "LAML", "LGG", "LIHC", "LUAD", "LUSC", "MESO", "OV", "PAAD", "PCPG", "PRAD", "READ", "SARC", "SKCM", "STAD", "STES", "TGCT", "THCA", "THYM", "UCEC", "UCS", "UVM")
...
# Rename the results folder
system(paste0("mv res ", selected_genes, ".Analysis2"))
```
...
if (subcategories_in_all_cancers) {
  cancer <- c("ACC", "BLCA", "BRCA", "CESC", "CHOL", "COAD", "COADREAD", "DLBC", "ESCA", "FPPP", "GBM", "GBMLGG", "HNSC", "KICH", "KIPAN", "KIRC", "KIRP", "LAML", "LGG", "LIHC", "LUAD", "LUSC", "MESO", "OV", "PAAD", "PCPG", "PRAD", "READ", "SARC", "SKCM", "STAD", "STES", "TGCT", "THCA", "THYM", "UCEC", "UCS", "UVM") 
} else {
...
# Rename the results folder
system(paste0("mv res ", selected_genes, ".Analysis3"))
```
...
system(paste0("mv res ", selected_genes, ".Analysis5"))
```
